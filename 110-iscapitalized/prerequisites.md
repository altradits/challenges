...
- [../105-clean-the-list/skills.md](../105-clean-the-list/skills.md) — covers `unicode.ToUpper` and working with runes
- [../95-firstword/skills.md](../95-firstword/skills.md) — covers `strings.Fields` for splitting into words
...
- [111-itoa-manual](../111-itoa-manual/README.md)
