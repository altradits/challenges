# Skills for 29-countchar

## What You'll Learn

**Previous:** [28-findchar](../28-findchar/skills.md) | **Next:** [30-findlastchar](../30-findlastchar/skills.md)
...
This is the accumulator pattern from [13-stringlength](../13-stringlength/skills.md), filtered by a specific character comparison. Notice that the index `i` is not needed — use `_` to discard it.

### Two-Parameter Functions with a `rune` Argument

You saw this signature in [28-findchar](../28-findchar/skills.md):
...
**Next:** [30-findlastchar](../30-findlastchar/README.md)
