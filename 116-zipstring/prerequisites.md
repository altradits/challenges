...
- [../93-countrepeats/skills.md](../93-countrepeats/skills.md) — covers the same "compare to previous, track state" pattern; this challenge adds counting each run's length
- [../111-itoa-manual/skills.md](../111-itoa-manual/skills.md) — covers converting integers to their character representation
...
- [117-addprimesum](../117-addprimesum/README.md)
