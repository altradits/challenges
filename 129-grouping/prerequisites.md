# Prerequisites for 129-grouping
...
Review: [66-checknumber](../66-checknumber/skills.md) — byte indexing with `s[0]`, `s[len(s)-1]`.
...
Review: [75-titlecase](../75-titlecase/skills.md) — unicode package usage.
...
- [130-financial-freedom-api](../130-financial-freedom-api/README.md)
