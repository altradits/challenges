...
- [../90-clean-the-list/skills.md](../90-clean-the-list/skills.md) — covers `strings.TrimSpace` and working with word-by-word processing
- [../80-firstword/skills.md](../80-firstword/skills.md) — introduces `strings.Fields`
- [../87-splitjoin/skills.md](../87-splitjoin/skills.md) — shows how Join works internally
...
- [92-expandstr](../92-expandstr/README.md)
