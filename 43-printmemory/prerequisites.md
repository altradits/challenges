...
- [42-arrays](../42-arrays/skills.md) — dedicated lesson on Go arrays: declaration, iteration, arrays vs slices, `[10]byte`
- [../41-itoa-35/skills.md](../41-itoa-35/skills.md) — covers digit-by-digit extraction; similar pattern of processing one value at a time
- [../26-hashcode/skills.md](../26-hashcode/skills.md) — covers ASCII values and converting between int and character
...
- [Next challenge](../44-printrevcomb/README.md)
