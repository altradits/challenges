# Skills for 43-findchar

## What You'll Learn

**Previous:** [42-wordcount](../42-wordcount/skills.md) | **Next:** [44-countchar](../44-countchar/skills.md)
...
This is early-return from [35-checknumber](../35-checknumber/skills.md), but now you return the **index** instead of `true`.
...
**Next:** [44-countchar](../44-countchar/README.md)
