...
**Challenge:** Write a function `RevConcatAlternate()` that receives two slices of `int` as arguments and returns a new slice with alternated values of each slice in reverse order.

## New Concept

Reverse alternate concatenation
