...
**Previous:** [05-onlyz](../05-onlyz/skills.md)

If you're stuck, review the previous exercise's skills.md to strengthen your foundation.

**Challenge:** Write a function that takes a `string` as an argument and returns `true` if the string contains any number, otherwise return `false`.

## New Concept

Using for...range to iterate over strings and checking conditions with if statements
...
**Next:** [07-countalpha](../07-countalpha/skills.md) - Countalpha
