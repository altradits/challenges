...
## Review If Stuck
- [130-notdecimal](../130-notdecimal/skills.md) — covers string scanning to find a specific character and slicing at that index
- [125-reversestrcap](../125-reversestrcap/skills.md) — covers character-by-character string scanning with conditions
...
- [140-romannumbers](../140-romannumbers/README.md)
