...
- [../80-firstword/skills.md](../80-firstword/skills.md) — covers `strings.Fields` and safe slice indexing for `words[0]`; the same pattern applies to the last element
...
- [84-longestword](../84-longestword/README.md)
