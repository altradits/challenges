...
- [../81-gcd/skills.md](../81-gcd/skills.md) — covers the modulo operator and breaking a problem into smaller steps
- [../79-digitlen/skills.md](../79-digitlen/skills.md) — covers while-style for loops that count down/change `n`
