# Prerequisites for 115-stringjoin
...
- [104-join](../104-join/skills.md) — covers the exact same algorithm using `+=` (this challenge upgrades it with Builder)
- [113-stringbuilder](../113-stringbuilder/skills.md) — covers why Builder is O(n) vs `+=` O(n²)
...
- [116-stringrepeat](../116-stringrepeat/README.md)
