# Prerequisites for 57-cameltosnakecase
...
- [52-countwords](../52-countwords/skills.md) — covers `unicode.IsLetter`, `unicode.IsDigit`, and iteration with index
- [56-join](../56-join/skills.md) — covers building result strings character by character
