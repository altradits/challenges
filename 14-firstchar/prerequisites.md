# Prerequisites for 14-firstchar
...
If you haven't written a function yet, complete [13-stringlength](../13-stringlength/README.md) first.

### 2. The `for...range` Loop on Strings

From [13-stringlength](../13-stringlength/skills.md): `for...range` iterates over each character (rune) in a string:
...
- [13-stringlength skills.md](../13-stringlength/skills.md) — covers `for...range` on strings and the basics of returning from a function
...
- [15-lastchar](../15-lastchar/README.md)
- [15-lastchar README](../15-lastchar/README.md) — next challenge
