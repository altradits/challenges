...
- [../25-gcd/skills.md](../25-gcd/skills.md) — covers the modulo operator and breaking a problem into smaller steps
- [../22-digitlen/skills.md](../22-digitlen/skills.md) — covers while-style for loops that count down/change `n`
...
- [Next challenge](../39-fromto/README.md)
