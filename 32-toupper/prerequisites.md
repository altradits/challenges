...
From [28-stringlength skills.md](../28-stringlength/skills.md): iterating character by character:
...
You have seen this pattern in [29-firstchar](../29-firstchar/skills.md) and [30-lastchar](../30-lastchar/skills.md) (in a simpler form). Here you do it for every character.
...
- [28-stringlength skills.md](../28-stringlength/skills.md) — `for...range` loop
- [29-firstchar skills.md](../29-firstchar/skills.md) — `string()` conversion
- [31-isempty skills.md](../31-isempty/skills.md) — boolean conditions and `==`
...
- [33-tolower](../33-tolower/README.md)
