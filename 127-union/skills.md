...
**Previous:** [126-saveandmiss](../126-saveandmiss/skills.md) | **Next:** [128-wdmatch](../128-wdmatch/skills.md)
...
|-----------|---------------|------------|
| Intersection (124-inter) | "in s2" set + "printed" set | Walk s1, check both maps |
...
**Next:** [128-wdmatch](../128-wdmatch/README.md)
