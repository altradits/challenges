# Skills for 16-retainfirsthalf

## What You'll Learn

**Previous:** [15-removespaces](../15-removespaces/skills.md)

If you're stuck, review the previous exercise's skills.md to strengthen your foundation.

**Challenge:** Write a function called `RetainFirstHalf()` that takes a `string` as an argument and returns the first half of this `string`.

## New Concept

String slicing with s[:n] and integer division
...
**Next:** [17-reversestring](../17-reversestring/skills.md) - Reversestring
