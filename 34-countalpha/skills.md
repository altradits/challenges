# Skills for 34-countalpha

## What You'll Learn

**Previous:** [33-tolower](../33-tolower/skills.md) | **Next:** [35-checknumber](../35-checknumber/skills.md)
...
|-----------|---------------------|---------|
| 32-toupper | Transform character | `string` |
| 31-isempty | Stop at first match | `bool` |
| 34-countalpha | Count matching characters | `int` |
...
**Next:** [35-checknumber](../35-checknumber/README.md)
