# Prerequisites for 126-brackets
...
Review: [66-checknumber](../66-checknumber/skills.md) — covers for...range on strings.
...
Review: [127-rpncalc](../127-rpncalc/skills.md) — switch usage (even though 73 comes after, the syntax is the same).
...
- [127-rpncalc](../127-rpncalc/README.md)
