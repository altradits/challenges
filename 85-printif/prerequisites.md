...
- [81-checknumber](../81-checknumber/skills.md) — covers `for...range`, rune comparisons, and boolean returns
- [84-findsubstring](../84-findsubstring/skills.md) — covers `len()` and string slicing
...
- [86-printifnot](../86-printifnot/README.md)
