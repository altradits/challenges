...
**Challenge:** Write a program called `rn`. The objective is to convert a number, given as an argument, into a roman number and print it with its roman number calculation.

## New Concept

Roman numeral conversion and number system mapping
