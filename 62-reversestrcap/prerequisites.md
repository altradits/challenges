# Prerequisites for 62-reversestrcap
...
- [57-cameltosnakecase](../57-cameltosnakecase/skills.md) — covers `unicode.IsUpper`, `unicode.IsLower` and case detection
- [56-join](../56-join/skills.md) — covers joining strings
