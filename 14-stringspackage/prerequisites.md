# Prerequisites for 14-stringspackage
...
See [11-forloops](../11-forloops/skills.md) for a refresher on for loops.
...
- [11-forloops](../11-forloops/skills.md) — covers for loops and range
