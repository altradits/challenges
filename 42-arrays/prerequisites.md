...
See [../34-slicesintro/skills.md](../34-slicesintro/skills.md) for a full introduction.
...
See [../11-forloops/skills.md](../11-forloops/skills.md) for a full introduction.

### 3. `fmt.Printf` with Format Verbs
The next challenge (`43-printmemory`) uses `fmt.Printf` to format byte values in hexadecimal and as characters. Get comfortable with the basic format verbs now.
```go
