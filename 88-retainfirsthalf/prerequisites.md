# Prerequisites for 88-retainfirsthalf
...
- [84-findsubstring](../84-findsubstring/skills.md) — covers `len()` and string slicing `s[start:end]`
- [85-printif](../85-printif/skills.md) — covers `if/else` with `len()`
...
- [89-reversestring](../89-reversestring/README.md)
