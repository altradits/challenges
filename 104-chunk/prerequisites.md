...
- [../87-splitjoin/skills.md](../87-splitjoin/skills.md) — covers building a `[]string` slice with `append`; the same pattern applies to `[][]int`
- [../103-canjump/skills.md](../103-canjump/skills.md) — covers index arithmetic and bounds checking on slices
...
- [105-concatalternate](../105-concatalternate/README.md)
