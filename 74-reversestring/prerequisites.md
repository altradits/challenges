# Prerequisites for 74-reversestring
...
- [72-removespaces](../72-removespaces/skills.md) — covers `strings.Builder` and building strings character by character
- [73-retainfirsthalf](../73-retainfirsthalf/skills.md) — covers `len()` and working with string indices
...
- [75-titlecase](../75-titlecase/README.md)
