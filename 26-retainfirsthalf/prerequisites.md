# Prerequisites for 26-retainfirsthalf
...
From [15-lastchar skills.md](../15-lastchar/skills.md): `len(s)` gives you an integer — the number of bytes in the string. For ASCII strings this equals the character count.
...
From [14-firstchar skills.md](../14-firstchar/skills.md) and [15-lastchar skills.md](../15-lastchar/skills.md): check edge cases first and return early:
...
- [14-firstchar skills.md](../14-firstchar/skills.md) — empty-string guard
...
- [27-wordcount](../27-wordcount/README.md)
- [27-wordcount README](../27-wordcount/README.md) — next challenge
