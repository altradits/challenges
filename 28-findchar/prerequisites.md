...
From [13-stringlength skills.md](../13-stringlength/skills.md) you used `for _, c := range s` to discard the index. Now you need both:
...
From [20-checknumber skills.md](../20-checknumber/skills.md): return inside a loop to stop immediately when a condition is met. Here you return the index rather than `true`:
...
- [13-stringlength skills.md](../13-stringlength/skills.md) — `for...range` basics
- [20-checknumber skills.md](../20-checknumber/skills.md) — early return pattern
...
- [29-countchar](../29-countchar/README.md)
- [29-countchar README](../29-countchar/README.md) — next challenge
