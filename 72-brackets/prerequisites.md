...
Review: [34-slicesintro](../34-slicesintro/skills.md) — covers append, slice reslicing, nil vs empty.
...
Review: [06-checknumber](../06-checknumber/skills.md) — covers for...range on strings.
...
Review: [73-rpncalc](../73-rpncalc/skills.md) — switch usage (even though 73 comes after, the syntax is the same).
...
- [73-rpncalc](../73-rpncalc/README.md)
