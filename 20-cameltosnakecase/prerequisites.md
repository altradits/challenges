# Prerequisites for 20-cameltosnakecase
...
- [15-removespaces](../15-removespaces/skills.md) — covers `strings.Builder` and filtering characters
- [18-titlecase](../18-titlecase/skills.md) — covers `unicode.ToUpper`/`ToLower` and character-by-character processing
- [06-checknumber](../06-checknumber/skills.md) — covers `for...range` and early return for validation
...
- [21-countrepeats](../21-countrepeats/README.md)
