...
- [../83-lastword/skills.md](../83-lastword/skills.md) — covers `strings.Fields` and safe slice access patterns
- [../80-firstword/skills.md](../80-firstword/skills.md) — covers `strings.Fields` and the empty slice guard
...
- [85-replaceall](../85-replaceall/README.md)
