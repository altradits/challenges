# Prerequisites for 37-reversestring
...
From [28-stringlength skills.md](../28-stringlength/skills.md): you know how to iterate over characters. This challenge takes that further by working with indices too.
...
- [32-toupper skills.md](../32-toupper/skills.md) — building a new string from characters; immutability
...
- [38-ispalindrome](../38-ispalindrome/README.md)
