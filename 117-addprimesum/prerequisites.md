...
- [../108-findprevprime/skills.md](../108-findprevprime/skills.md) — covers writing an `isPrime` function using `i*i <= n`
- [../101-searchreplace/skills.md](../101-searchreplace/skills.md) — covers `os.Args` and argument count validation
...
- [118-canjump](../118-canjump/README.md)
