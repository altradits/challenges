...
- [../106-cleanstr/skills.md](../106-cleanstr/skills.md) — covers the `strings.Fields` + `strings.Join` + `os.Args` pattern; this challenge is nearly identical but uses 3 spaces and no output on bad args
...
- [108-findprevprime](../108-findprevprime/README.md)
