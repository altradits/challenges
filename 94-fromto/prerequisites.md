...
- [../93-findprevprime/skills.md](../93-findprevprime/skills.md) — covers downward iteration (`i--`)
- [../87-splitjoin/skills.md](../87-splitjoin/skills.md) — covers `strings.Join` and building slices with `append`
...
- [95-iscapitalized](../95-iscapitalized/README.md)
