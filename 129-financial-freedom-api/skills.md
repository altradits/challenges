# Skills for 129-financial-freedom-api

## What You'll Learn

**Previous:** [128-stringformat](../128-stringformat/skills.md)

If you're stuck, review the previous exercise's skills.md to strengthen your foundation.

**Challenge:** Financial Freedom Api
...
CalculateRunway implementation here

func main() {
    // Test your function
    fmt.Println(CalculateRunway())
}
```
...
**Next:** [130-index-fund-tracker](../130-index-fund-tracker/skills.md) - 130 Index Fund Tracker
