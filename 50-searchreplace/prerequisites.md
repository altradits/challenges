# Prerequisites for 50-searchreplace
...
Review: [41-retainfirsthalf](../41-retainfirsthalf/skills.md)
...
Review: [53-findsubstring](../53-findsubstring/skills.md) for the manual approach.
...
- [51-cleanlist](../51-cleanlist/README.md)
