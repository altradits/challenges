...
**Challenge:** Write a function that takes a string as an argument and returns the string reversed.

## New Concept

Converting strings to []rune for modification and two-pointer swap technique
