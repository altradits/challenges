# Skills for 44-countchar

## What You'll Learn

**Previous:** [43-findchar](../43-findchar/skills.md) | **Next:** [45-findlastchar](../45-findlastchar/skills.md)
...
This is the accumulator pattern from [28-stringlength](../28-stringlength/skills.md), filtered by a specific character comparison. Notice that the index `i` is not needed — use `_` to discard it.

### Two-Parameter Functions with a `rune` Argument

You saw this signature in [43-findchar](../43-findchar/skills.md):
...
**Next:** [45-findlastchar](../45-findlastchar/README.md)
