...
**Previous:** [49-canjump](../49-canjump/skills.md)

If you're stuck, review the previous exercise's skills.md to strengthen your foundation.

**Challenge:** Write a function called `Chunk` that receives as parameters a slice, `slice []int`, and a number `size int`. The goal of this function is to chunk a slice into many sub slices where each sub slice has the length of `size`.

## New Concept

Slice chunking into sub-slices
...
**Next:** [51-concatalternate](../51-concatalternate/skills.md) - Concatalternate
