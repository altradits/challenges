...
- [../78-countrepeats/skills.md](../78-countrepeats/skills.md) — covers the same "compare to previous, track state" pattern; this challenge adds counting each run's length
- [../96-itoa-manual/skills.md](../96-itoa-manual/skills.md) — covers converting integers to their character representation
...
- [102-addprimesum](../102-addprimesum/README.md)
