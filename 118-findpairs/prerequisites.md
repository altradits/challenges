...
## Review If Stuck
- [109-inter](../109-inter/skills.md) — covers using maps for set operations
- [107-fprime](../107-fprime/skills.md) — covers `strconv.Atoi` and `os.Args` validation
- [117-slice](../117-slice/skills.md) — covers string slicing with `s[1:len-1]`
...
## Next Steps
- [119-revwstr](../119-revwstr/README.md)
