...
### 5. Relationship to Split (from 55-split)
...
- [55-split](../55-split/skills.md) — covers the inverse operation and slice fundamentals
...
- [57-cameltosnakecase](../57-cameltosnakecase/README.md)
