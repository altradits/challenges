# Prerequisites for 24-recursion
...
You must be comfortable writing a function that takes a parameter and returns a value. See [07-functions](../07-functions/skills.md) for a refresher.
...
- [07-functions](../07-functions/skills.md) — covers defining functions with parameters and return values
- [12-printif](../12-printif/skills.md) — covers `if/else` conditionals
