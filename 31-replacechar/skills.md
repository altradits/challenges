# Skills for 31-replacechar

## What You'll Learn

**Previous:** [30-findlastchar](../30-findlastchar/skills.md) | **Next:** [32-printif](../32-printif/skills.md)
...
Replacement combines the filter pattern (from [24-removespaces](../24-removespaces/skills.md)) with the transform pattern (from [17-toupper](../17-toupper/skills.md)). Instead of removing a character or changing its case, you substitute it with a different specific character.
...
|-----------|------------|----------------|--------|
| 24-removespaces | Drop the character | Keep | Filtered string |
| 17-toupper | Change the character | Keep | Transformed string |
| 31-replacechar | Substitute with `new` | Keep `old` value | Substituted string |
...
**Next:** [32-printif](../32-printif/README.md)
