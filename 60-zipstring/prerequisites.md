# Prerequisites for 60-zipstring
...
- [58-itoa](../58-itoa/skills.md) — covers converting integers to strings
- [59-thirdchar](../59-thirdchar/skills.md) — covers index-based character selection
...
- [61-saveandmiss](../61-saveandmiss/README.md)
