...
**Challenge:** Write a function that takes a string as an argument and returns the string converted to title case.

## New Concept

Word boundary detection and state tracking for capitalization
