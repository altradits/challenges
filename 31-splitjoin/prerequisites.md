...
- [../29-replaceall/skills.md](../29-replaceall/skills.md) — covers index-based scanning and substring comparison with `s[i:j]`
...
- [Next challenge](../32-wordanatomy/README.md)
