...
**Challenge:** Write a program that reduces a string to a single value by applying a function cumulatively.

## New Concept

Cumulative reduction and fold operation
