# Skills for 54-stringreplace

**Previous:** [53-stringrepeat](../53-stringrepeat/skills.md) | **Next:** [55-stringtrim](../55-stringtrim/skills.md)
...
This challenge revisits the replace-all pattern from [39-replaceall](../39-replaceall/skills.md), but now you can use `strings.Index` to jump directly to each occurrence rather than scanning character by character.
...
**Next:** [55-stringtrim](../55-stringtrim/README.md)
