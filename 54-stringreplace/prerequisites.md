# Prerequisites for 54-stringreplace
...
### 3. `strings.Builder` (from 50-stringbuilder)
...
- [39-replaceall](../39-replaceall/skills.md) — covers the same algorithm using manual character scanning
- [50-stringbuilder](../50-stringbuilder/skills.md) — covers `strings.Builder`
...
- [55-stringtrim](../55-stringtrim/README.md)
