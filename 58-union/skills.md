...
**Challenge:** Write a program that takes two `string` and displays, without doubles, the characters that appear in either one of the `string`.

## New Concept

Set union with duplicate removal and order preservation
