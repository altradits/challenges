# Prerequisites for 20-checknumber
...
From [16-isempty skills.md](../16-isempty/skills.md): a boolean function answers a yes/no question:
...
From [13-stringlength skills.md](../13-stringlength/skills.md): iterate over every character:
...
From [19-countalpha skills.md](../19-countalpha/skills.md): you can check whether a rune falls in a range using `>=` and `<=`. For digits:
...
You already returned inside a loop in [14-firstchar](../14-firstchar/skills.md):
...
- [16-isempty skills.md](../16-isempty/skills.md) — `bool` return type
- [19-countalpha skills.md](../19-countalpha/skills.md) — range checks with `&&`
...
- [21-countvowels](../21-countvowels/README.md)
- [21-countvowels README](../21-countvowels/README.md) — next challenge
