# Skills for 67-wordflip

## What You'll Learn

**Previous:** [66-rostring](../66-rostring/skills.md)

If you're stuck, review the previous exercise's skills.md to strengthen your foundation.

**Challenge:** Write a function `WordFlip()` that takes a `string` as input and returns it in reverse order.

## New Concept

Word order flipping and string rearrangement
...
**Next:** [68-itoabase](../68-itoabase/skills.md) - Itoabase
