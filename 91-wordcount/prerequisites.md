# Prerequisites for 91-wordcount
...
- [90-titlecase](../90-titlecase/skills.md) — covers `strings.Fields`, `strings.Join`, and boolean state flags
- [82-count-character](../82-count-character/skills.md) — covers the counter pattern with `for...range`
...
- [92-cameltosnakecase](../92-cameltosnakecase/README.md)
