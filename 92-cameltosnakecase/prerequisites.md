# Prerequisites for 92-cameltosnakecase
...
- [87-removespaces](../87-removespaces/skills.md) — covers `strings.Builder` and filtering characters
- [90-titlecase](../90-titlecase/skills.md) — covers `unicode.ToUpper`/`ToLower` and character-by-character processing
- [81-checknumber](../81-checknumber/skills.md) — covers `for...range` and early return for validation
...
- [93-countrepeats](../93-countrepeats/README.md)
