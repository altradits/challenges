# Skills for 52-stringjoin

**Previous:** [51-stringsplit](../51-stringsplit/skills.md) | **Next:** [53-stringrepeat](../53-stringrepeat/skills.md)
...
1. The "separator between, not after" pattern from [41-join](../41-join/skills.md)
2. The `strings.Builder` efficiency from [50-stringbuilder](../50-stringbuilder/skills.md)
...
**Next:** [53-stringrepeat](../53-stringrepeat/README.md)
