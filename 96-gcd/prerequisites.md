...
- [../94-digitlen/skills.md](../94-digitlen/skills.md) — covers the same "loop until zero" logic as an iterative alternative to recursion
...
- [97-hashcode](../97-hashcode/README.md)
