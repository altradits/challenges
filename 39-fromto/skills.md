# Skills for 39-fromto

## What You'll Learn

**Previous:** [38-findprevprime](../38-findprevprime/skills.md)

If you're stuck, review the previous exercise's skills.md to strengthen your foundation.

**Challenge:** Write a function that takes two `integers` and returns a `string` showing the range of numbers from the first to the second.

## New Concept

Number range generation and string formatting
...
**Next:** [40-iscapitalized](../40-iscapitalized/skills.md) - Iscapitalized
