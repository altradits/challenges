...
## Review If Stuck
- [107-fprime](../107-fprime/skills.md) — covers repeated division with `%` and `/` (same pattern as base conversion)
- [121-wordflip](../121-wordflip/skills.md) — covers string building and prepending
...
## Next Steps
- [123-options](../123-options/README.md)
