...
- [../25-gcd/skills.md](../25-gcd/skills.md) — covers modulo arithmetic
- [../21-countrepeats/skills.md](../21-countrepeats/skills.md) — covers index-based for loop over a string
...
- [Next challenge](../46-weareunique/README.md)
