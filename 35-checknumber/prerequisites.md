# Prerequisites for 35-checknumber
...
From [31-isempty skills.md](../31-isempty/skills.md): a boolean function answers a yes/no question:
...
From [28-stringlength skills.md](../28-stringlength/skills.md): iterate over every character:
...
From [34-countalpha skills.md](../34-countalpha/skills.md): you can check whether a rune falls in a range using `>=` and `<=`. For digits:
...
You already returned inside a loop in [29-firstchar](../29-firstchar/skills.md):
...
- [31-isempty skills.md](../31-isempty/skills.md) — `bool` return type
- [34-countalpha skills.md](../34-countalpha/skills.md) — range checks with `&&`
...
- [36-countvowels](../36-countvowels/README.md)
