# Prerequisites for 53-stringrepeat
...
- [50-stringbuilder](../50-stringbuilder/skills.md) — covers `strings.Builder` and O(n) vs O(n²)
- [52-stringjoin](../52-stringjoin/skills.md) — another example of Builder with Grow
...
- [54-stringreplace](../54-stringreplace/README.md)
