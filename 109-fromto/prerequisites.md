...
- [../108-findprevprime/skills.md](../108-findprevprime/skills.md) — covers downward iteration (`i--`)
- [../102-splitjoin/skills.md](../102-splitjoin/skills.md) — covers `strings.Join` and building slices with `append`
...
- [110-iscapitalized](../110-iscapitalized/README.md)
