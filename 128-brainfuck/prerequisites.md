# Prerequisites for 128-brainfuck
...
### 2. `switch` statement from 127-rpncalc
...
Review: [127-rpncalc](../127-rpncalc/skills.md)
...
Review: [126-brackets](../126-brackets/skills.md) — same nesting logic.
...
- [129-grouping](../129-grouping/README.md)
