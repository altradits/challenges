...
- [07-forloops](../07-forloops/skills.md) — dedicated lesson on all for loop patterns in Go
- [66-checknumber](../66-checknumber/skills.md) — covers `for...range`, rune comparisons, and boolean returns
- [69-findsubstring](../69-findsubstring/skills.md) — covers `len()` and string slicing
...
- [71-printifnot](../71-printifnot/README.md)
