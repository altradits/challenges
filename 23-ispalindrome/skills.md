# Skills for 23-ispalindrome

## What You'll Learn

**Previous:** [22-reversestring](../22-reversestring/skills.md) | **Next:** [24-removespaces](../24-removespaces/skills.md)
...
This uses:
- Lowercase range from [19-countalpha](../19-countalpha/skills.md)
- Digit range from [20-checknumber](../20-checknumber/skills.md)
- Case conversion from [18-tolower](../18-tolower/skills.md)

### Step 2 — Reversing

Use the `[]rune` two-pointer technique from [22-reversestring](../22-reversestring/skills.md):
...
**Next:** [24-removespaces](../24-removespaces/README.md)
