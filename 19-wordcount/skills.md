...
**Challenge:** Write a function that takes a string as an argument and returns the number of words in the string.

## New Concept

Word boundary detection using state tracking (inWord flag)
