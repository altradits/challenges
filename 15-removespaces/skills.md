...
**Previous:** [14-rectperimeter](../14-rectperimeter/skills.md)

If you're stuck, review the previous exercise's skills.md to strengthen your foundation.

**Challenge:** Write a function that takes a string as an argument and returns a new string with all spaces removed.

## New Concept

String filtering - building new strings by excluding specific characters
