...
## Review If Stuck
- [115-notdecimal](../115-notdecimal/skills.md) — covers string scanning to find a specific character and slicing at that index
- [110-reversestrcap](../110-reversestrcap/skills.md) — covers character-by-character string scanning with conditions
...
## Next Steps
- [125-romannumbers](../125-romannumbers/README.md)
