...
- [../79-digitlen/skills.md](../79-digitlen/skills.md) — covers the `for n > 0 { n /= base }` pattern that is the backbone of this function
- [../82-hashcode/skills.md](../82-hashcode/skills.md) — covers converting between integer values and string characters
...
- [97-printmemory](../97-printmemory/README.md)
