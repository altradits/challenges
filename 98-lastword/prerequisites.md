...
- [../95-firstword/skills.md](../95-firstword/skills.md) — covers `strings.Fields` and safe slice indexing for `words[0]`; the same pattern applies to the last element
...
- [99-longestword](../99-longestword/README.md)
