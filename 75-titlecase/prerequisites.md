# Prerequisites for 75-titlecase
...
- [72-removespaces](../72-removespaces/skills.md) — covers `strings.Builder` and character filtering
- [74-reversestring](../74-reversestring/skills.md) — covers `[]rune` conversion and indexed mutation
...
- [76-wordcount](../76-wordcount/README.md)
