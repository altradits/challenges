...
If this looks unfamiliar, see [28-stringlength skills.md](../28-stringlength/skills.md).
...
From [29-firstchar skills.md](../29-firstchar/skills.md).
...
- [29-firstchar skills.md](../29-firstchar/skills.md) — covers string indexing and `byte`-to-`string` conversion
- [28-stringlength skills.md](../28-stringlength/skills.md) — covers `for...range` as an alternative approach
...
- [31-isempty](../31-isempty/README.md)
