...
- [../87-splitjoin/skills.md](../87-splitjoin/skills.md) — covers building a `[]string` slice with `append`
- [../82-hashcode/skills.md](../82-hashcode/skills.md) — covers character-level operations using runes
...
- [91-cleanstr](../91-cleanstr/README.md)
