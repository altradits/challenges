# Prerequisites for 70-stringtrim
...
- [52-countwords](../52-countwords/skills.md) — covers `unicode` package for character classification
...
- [71-stringcontains](../71-stringcontains/README.md)
