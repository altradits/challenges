...
## Review If Stuck
- [123-hiddenp](../123-hiddenp/skills.md) — teaches exactly this subsequence matching algorithm
- [127-union](../127-union/skills.md) — covers `for range` string iteration and `os.Args`
...
- [129-fifthandskip](../129-fifthandskip/README.md)
