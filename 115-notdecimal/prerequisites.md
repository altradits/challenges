...
## Review If Stuck
- [114-fifthandskip](../114-fifthandskip/skills.md) — covers string scanning and conditional building
- [107-fprime](../107-fprime/skills.md) — covers `strconv.Atoi` (for contrast — here we avoid float conversion)
...
## Next Steps
- [116-revconcatalternate](../116-revconcatalternate/README.md)
