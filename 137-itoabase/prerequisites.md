...
## Review If Stuck
- [122-fprime](../122-fprime/skills.md) — covers repeated division with `%` and `/` (same pattern as base conversion)
- [136-wordflip](../136-wordflip/skills.md) — covers string building and prepending
...
- [138-options](../138-options/README.md)
