# Prerequisites for 65-stringbuilder
...
- [63-union](../63-union/skills.md) and [64-inter](../64-inter/skills.md) — both use `result += string(c)` which is fine for small inputs. This challenge teaches the proper approach for large inputs.
...
- [66-stringsplit](../66-stringsplit/README.md)
