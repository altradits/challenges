# Prerequisites for 47-reversestrcap
...
- [42-cameltosnakecase](../42-cameltosnakecase/skills.md) — covers `unicode.IsUpper`, `unicode.IsLower` and case detection
- [41-join](../41-join/skills.md) — covers joining strings
