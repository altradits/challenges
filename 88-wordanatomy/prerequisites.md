...
- [../85-replaceall/skills.md](../85-replaceall/skills.md) — covers string slicing and bounds checking
- [../84-longestword/skills.md](../84-longestword/skills.md) — covers the running-maximum pattern for tracking the longest match
...
- [89-wordanatomy2](../89-wordanatomy2/README.md)
