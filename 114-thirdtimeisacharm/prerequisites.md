...
- [../96-gcd/skills.md](../96-gcd/skills.md) — covers modulo arithmetic
- [../93-countrepeats/skills.md](../93-countrepeats/skills.md) — covers index-based for loop over a string
...
- [115-weareunique](../115-weareunique/README.md)
