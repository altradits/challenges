# Prerequisites for 67-count-character
...
- [66-checknumber](../66-checknumber/skills.md) — covers `for...range` on strings and rune comparisons
...
- [68-missing-pieces](../68-missing-pieces/README.md)
