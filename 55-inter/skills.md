...
**Previous:** [54-hiddenp](../54-hiddenp/skills.md)

If you're stuck, review the previous exercise's skills.md to strengthen your foundation.

**Challenge:** Write a program that takes two `string` and displays, without doubles, the characters that appear in both `string`, in the order they appear in the first one.

## New Concept

Set intersection for finding common characters
...
**Next:** [56-reversestrcap](../56-reversestrcap/skills.md) - Reversestrcap
