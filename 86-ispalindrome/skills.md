# Skills for 11. Is Palindrome

## What You'll Learn

This exercise is part of the **Main Course - Beginner-Intermediate** series. By completing it, you'll master the logic needed to solve this type of problem and be prepared for similar challenges.

**Challenge:** Write a function that takes a string as an argument and returns `true` if the string is a palindrome, otherwise returns `false`.
