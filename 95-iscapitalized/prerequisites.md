...
- [../90-clean-the-list/skills.md](../90-clean-the-list/skills.md) — covers `unicode.ToUpper` and working with runes
- [../80-firstword/skills.md](../80-firstword/skills.md) — covers `strings.Fields` for splitting into words
...
- [96-itoa-manual](../96-itoa-manual/README.md)
