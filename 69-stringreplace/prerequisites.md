# Prerequisites for 69-stringreplace
...
### 3. `strings.Builder` (from 65-stringbuilder)
...
- [54-replaceall](../54-replaceall/skills.md) — covers the same algorithm using manual character scanning
- [65-stringbuilder](../65-stringbuilder/skills.md) — covers `strings.Builder`
...
- [70-stringtrim](../70-stringtrim/README.md)
