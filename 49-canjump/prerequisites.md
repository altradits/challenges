...
- [../38-findprevprime/skills.md](../38-findprevprime/skills.md) — covers loops that terminate based on computed conditions
- [../35-clean-the-list/skills.md](../35-clean-the-list/skills.md) — covers working with slice values
...
- [Next challenge](../50-chunk/README.md)
