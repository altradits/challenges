...
- [../94-digitlen/skills.md](../94-digitlen/skills.md) — covers the `for n > 0 { n /= base }` pattern that is the backbone of this function
- [../97-hashcode/skills.md](../97-hashcode/skills.md) — covers converting between integer values and string characters
...
- [112-printmemory](../112-printmemory/README.md)
