# Prerequisites for 73-retainfirsthalf
...
- [69-findsubstring](../69-findsubstring/skills.md) — covers `len()` and string slicing `s[start:end]`
- [70-printif](../70-printif/skills.md) — covers `if/else` with `len()`
...
- [74-reversestring](../74-reversestring/README.md)
