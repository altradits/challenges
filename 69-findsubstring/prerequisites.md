# Prerequisites for 69-findsubstring
...
- [66-checknumber](../66-checknumber/skills.md) — covers `for...range` and character comparisons
- [67-count-character](../67-count-character/skills.md) — covers the counter pattern and rune iteration
...
- [70-printif](../70-printif/README.md)
