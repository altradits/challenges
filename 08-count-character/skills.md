...
**Previous:** [07-countalpha](../07-countalpha/skills.md)

If you're stuck, review the previous exercise's skills.md to strengthen your foundation.

**Challenge:** write a function that takes a string and a character as arguments and returns the number of times the character appears in the string.

## New Concept

Using rune type as function parameters and counting specific character occurrences
...
**Next:** [09-countvowels](../09-countvowels/skills.md) - Countvowels
