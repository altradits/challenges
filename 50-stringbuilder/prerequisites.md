# Prerequisites for 50-stringbuilder
...
- [48-union](../48-union/skills.md) and [49-inter](../49-inter/skills.md) — both use `result += string(c)` which is fine for small inputs. This challenge teaches the proper approach for large inputs.
...
- [51-stringsplit](../51-stringsplit/README.md)
