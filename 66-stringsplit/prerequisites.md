# Prerequisites for 66-stringsplit
...
### 5. `strings.Builder` from 65-stringbuilder
...
- [65-stringbuilder](../65-stringbuilder/skills.md) — covers efficient string building
- [55-split](../55-split/skills.md) — covers the manual splitting algorithm with a start pointer
...
- [67-stringjoin](../67-stringjoin/README.md)
