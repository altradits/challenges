# Prerequisites for 55-stringtrim
...
- [37-countwords](../37-countwords/skills.md) — covers `unicode` package for character classification
...
- [56-stringcontains](../56-stringcontains/README.md)
