# Skills for 59-wdmatch

## What You'll Learn

**Previous:** [58-union](../58-union/skills.md)

If you're stuck, review the previous exercise's skills.md to strengthen your foundation.

**Challenge:** Write a program that takes two `string` and checks whether it is possible to write the first `string` with characters from the second `string`. This rewrite must respect the order in which these characters appear in the second `string`.

## New Concept

Word matching and pattern comparison
...
**Next:** [60-fifthandskip](../60-fifthandskip/skills.md) - Fifthandskip
