# Prerequisites for 39-replaceall
...
Note: For large strings this is O(n²). You'll learn the efficient alternative in 50-stringbuilder.

## Review If Stuck

- [38-findsubstring](../38-findsubstring/skills.md) — covers locating a pattern at a given index within a string
