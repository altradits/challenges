# Skills for 82-count-character

## What You'll Learn

**Previous:** [81-checknumber](../81-checknumber/skills.md) | **Next:** [83-missing-pieces](../83-missing-pieces/skills.md)
...
In 81-checknumber you used `for...range` to find *whether* a character exists (returning `true` at the first match). Now you need to *count* all matches. Instead of returning early, you keep a counter and increment it every time the condition is true.
...
**Next:** [83-missing-pieces](../83-missing-pieces/README.md)
