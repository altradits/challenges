# Prerequisites for 82-count-character
...
- [81-checknumber](../81-checknumber/skills.md) — covers `for...range` on strings and rune comparisons
...
- [83-missing-pieces](../83-missing-pieces/README.md)
