...
## What's New in Phase 6 (145–152): Backend Bridge
...
| `148-database-sql` | `database/sql`, SQLite, QueryRow/Query, transactions, JOINs, migrations |
...
| `152-graceful-shutdown` | `os/signal`, `signal.Notify`, `http.Server.Shutdown` with context deadline |
