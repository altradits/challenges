...
- [../88-wordanatomy/skills.md](../88-wordanatomy/skills.md) — covers prefix/suffix detection and string slicing; this challenge adds first-match logic and formatted output
...
- [90-clean-the-list](../90-clean-the-list/README.md)
